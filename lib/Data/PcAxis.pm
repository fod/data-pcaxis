...
The following terms have specific meanings, as defined here, in this documentation:
...
This is the top level key of the metadata hash and is equivalent to the PC-Axis I<B<keyword>> defined in the PC-Axis file format specification (see L</REFERENCES>). Keywords are generally CAPITALISED. Examples of keywords would be TITLE, STUB, HEADING, SOURCE, or DATA.
